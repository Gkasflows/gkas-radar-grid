...
export default function Map() {
  ...
  return (
    <div style={{ position: 'relative', width: '100vw', height: '100vh', backgroundColor: '#0f172a' }}>
      ...
      {/* TACTICAL RADAR SWEEP CROSSHAIR (Only visible when Locked On and perfectly centered) */}
      {(selectedFlightId || selectedAirportIata) && isAnimatingRef.current && (
        <div style={{
          position: 'absolute',
          top: '50%',
          left: '50%',
          ...
          {/* Static distance bounds */}
          <div style={{ position: 'absolute', width: '100%', height: '100%', borderRadius: '50%', border: '1px solid rgba(0, 243, 255, 0.1)', boxShadow: 'inset 0 0 40px rgba(0,243,255,0.02)' }} />
          <div style={{ position: 'absolute', width: '60%', height: '60%', borderRadius: '50%', border: '1px solid rgba(0, 243, 255, 0.15)' }} />
          <div style={{ position: 'absolute', width: '30%', height: '30%', borderRadius: '50%', border: '1px dashed rgba(0, 243, 255, 0.25)' }} />
          
          {/* Sniper Crosshairs */}
          <div style={{ position: 'absolute', width: '1px', height: '100%', background: 'linear-gradient(to bottom, transparent, rgba(0,243,255,0.2) 40%, rgba(0,243,255,0.2) 60%, transparent)' }} />
          <div style={{ position: 'absolute', height: '1px', width: '100%', background: 'linear-gradient(to right, transparent, rgba(0,243,255,0.2) 40%, rgba(0,243,255,0.2) 60%, transparent)' }} />

          {/* Tactical Target Box (Inner core) */}
          <div style={{ 
            position: 'absolute', width: '48px', height: '48px', border: '1px solid #00f3ff', borderRadius: '4px', 
            boxShadow: '0 0 10px rgba(0,243,255,0.4), inset 0 0 10px rgba(0,243,255,0.2)', backgroundColor: 'rgba(0,243,255,0.05)' 
          }}>
            <div style={{ position: 'absolute', top: '-4px', left: '23px', width: '2px', height: '8px', background: '#00f3ff' }} />
            <div style={{ position: 'absolute', bottom: '-4px', left: '23px', width: '2px', height: '8px', background: '#00f3ff' }} />
            <div style={{ position: 'absolute', left: '-4px', top: '23px', height: '2px', width: '8px', background: '#00f3ff' }} />
            <div style={{ position: 'absolute', right: '-4px', top: '23px', height: '2px', width: '8px', background: '#00f3ff' }} />
          </div>

          {/* Majestic Rotational Conic Sweep */}
          <div style={{
            position: 'absolute',
            width: '100%',
            height: '100%',
            borderRadius: '50%',
            background: 'conic-gradient(from 0deg, transparent 65%, rgba(0, 243, 255, 0.15) 95%, rgba(0, 243, 255, 0.8) 100%)',
            animation: 'tacticalRadarSpin 3s linear infinite',
          }} />
          ...
          <div style={{
            ...
            animation: 'radarPulseExpansion 2s cubic-bezier(0.16, 1, 0.3, 1) infinite'
          }} />

          <style>{`
            @keyframes tacticalRadarSpin {
              0% { transform: rotate(0deg); }
              100% { transform: rotate(360deg); }
            }
            @keyframes radarPulseExpansion {
